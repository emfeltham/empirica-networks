...
export function Introduction({ next }) {
  ...
  function handleSubmit(event) {
    ...
    // republishes to exactly the neighbors who can see this participant.
  ...
  return (
    <div className="mt-3 sm:mt-5 p-20 max-w-prose">
      ...
      <div className="mt-2 mb-6 space-y-3 text-sm text-gray-500">
        <p>
          Everyone in this session sits on a ring. You will pick a color, and
          you will see the colors picked by the two participants next to you on
          that ring — nobody else&apos;s.
        </p>
        <p>
          This is not a display rule. Your color is stored on your own private
          channel, so a non-neighbor&apos;s color is never sent to your browser
