...
The generator catalogue. This is the page to read while *designing* a study — choosing a
structure and checking it will fit — rather than while writing code; for the surrounding API see
[API.md](API.md).
