...
gone wrong loudly. If you have an error message, jump to [Section 2](#2-errors-this-package-raises).
...
And a policy that throws is caught, logged, and swallowed, because one failing agent must not
